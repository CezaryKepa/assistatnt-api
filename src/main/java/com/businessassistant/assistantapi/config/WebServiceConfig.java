package com.businessassistant.assistantapi.config;

import com.businessassistant.assistantapi.exception.DetailSoapFaultDefinitionExceptionResolver;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema orderSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.kepa.com/api/order");
